...
import { generateSubtractionQuestions, type DigitLength } from '../../lib/generators'
...
export default function SubtractionPractice() {
  ...
  function newQuestions() {
    return generateSubtractionQuestions(lhsDigits, rhsDigits, count)
  }
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10">
      ...
      <h1 className="mt-2 text-3xl font-extrabold text-slate-900">Subtraction</h1>
      <p className="mt-2 text-slate-500">
        Pick a digit length for each side, e.g. double digit − single digit gives questions like 45 − 7 or 82 − 4. The
        second number can't be longer than the first, so results always stay positive.
      </p>
      ...
      <div className="mt-8 rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
        ...
        <p className="mt-2 text-xs text-slate-400">Limited to the first number's length or shorter, to avoid negative results.</p>
