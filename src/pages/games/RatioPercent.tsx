...
import { generateRatioQuestions, type RatioDifficulty } from '../../lib/generators'
...
export default function RatioPercent() {
  ...
  function generate() {
    return generateRatioQuestions(maxDenominator, difficulty, count)
  }
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10">
      ...
      <h1 className="mt-2 text-3xl font-extrabold text-slate-900">Ratios to Percentage</h1>
      <p className="mt-2 text-slate-500">
        Convert a fraction to a percentage, rounded to 2 decimals. e.g. 1/9 → <span className="font-mono">11.11</span>
      </p>
